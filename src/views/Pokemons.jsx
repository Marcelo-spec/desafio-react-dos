...
import { getPokemonsName, getPokemons } from "../components/ComponentPokemon";
...
const Pokemons = () => {
  ...
  return (
    <div className="result">
      ...
      <Row>
        <Col>
        <h2>Pokemon Capturado</h2>
          <Container>
            <Button variant="dark" onClick={regresar} className="back">
              {" "}
              Regresar{" "}
            </Button>
            {!poke && <span>Obteniendo</span>}
            {poke && (
